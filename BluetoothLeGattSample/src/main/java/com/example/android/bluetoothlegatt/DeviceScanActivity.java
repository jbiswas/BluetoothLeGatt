...
public class DeviceScanActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mBLEFoundTextView.setText("Looking for BLUEBIRD...");
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.menu_connect2:
                ...
                for(int i=0; i < mLeDeviceListAdapter.getCount(); i++)
                {
                    ...
                    if (d.getName() != null &&
                            d.getName().compareTo("BLUEBIRD") == 0)
                    {
    ...
    private class LeDeviceListAdapter extends BaseAdapter
    {
        ...
        public void addDevice(BluetoothDevice device)
        {
            if (!mLeDevices.contains(device))
            {
                ...
                String devCount = Integer.toString(mLeDevices.size()) + " devices found";
                mDevicesFoundTextView.setText(devCount);
                Log.i(TAG, "===================================");
                Log.i(TAG, "======>>>>> Adding device: " + (device.getName() == null ? "Unknown" : device.getName()));
                Log.i(TAG, "===================================");

                if (device.getName().compareTo("BLUEBIRD") == 0)
                    mBLEFoundTextView.setText("BLUEBIRD found!");
